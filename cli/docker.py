...
class Docker(CommandWrapper):
    ...
    @staticmethod
    def ps_cmd(docker_cmd: str = "docker", show_all: bool = False) -> str:
    ...
    def node_update_cmd(docker_cmd: str, node_name: str, availability: str) -> str:
        ...
        return (
            f"{docker_cmd} node update --availability {availability} {node_name} 2>&1"
        )
    ...
    @staticmethod
    def system_prune_cmd(
        docker_cmd: str, include_all: bool = False, force: bool = False
    ) -> str:
